...
{ purchase.length ? purchase.map(order => (
        <div  className="shadow border-gray-200 px-4 py-6 sm:px-6 lg:p-8" key={order.id}>
        <div class="space-y-4 p-6">
        
          <div class="flex items-center justify-between gap-4">
            <Link href={`/vendor/order/${order.id}`} class="text-sm font-normal text-gray-500 dark:text-gray-400"><span class="font-medium text-gray-900 dark:text-white">Product ID:</span> {order.order_number}</Link>
